...
Data Mining Project
------------------------------------------------------------------------------
Siddharth Nishtala, 1510110396
Achyut Ajith Kumar, 1510110015
Clint Johnson, 1510110113

This is our project of modelling People Supply Chain using Capgemini TechChallenge 2018's Data Science challenge dataset.

------------------------------------------------------------------------------
Instructions to run the project
------------------------------------------------------------------------------
1. Install the dependencies - NumPy, Pandas and Keras.
2. Change directory to '/People-Supply-Chain/src'.
